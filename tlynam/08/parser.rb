...
#Args: -
#Returns: -
#Function: Writes assembly code that effects the VM init, bootstrap code.  Placed at beginning of the ouput file.

#Method: writeLabel
#Args: label (string)
#Returns: - 
#Function: Writes assembly code that effects the label command.
  def writelabel label,output
file = <<PARAGRAPH
// Write Label #{label}
(#{label})
PARAGRAPH
